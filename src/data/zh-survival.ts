...
export const zhSurvival: Deck = {
  ...
  items: [
    ...
    // ---- Time & Days ----
    { id: 'zh-ti01', scenario: 'time', type: 'chunk', hanzi: '现在几点', pinyin: 'xiàn zài jǐ diǎn', gloss: 'what time is it now?', emoji: '⏰' },
    { id: 'zh-ti02', scenario: 'time', type: 'word', hanzi: '今天', pinyin: 'jīn tiān', gloss: 'today', emoji: '📅' },
    { id: 'zh-ti03', scenario: 'time', type: 'word', hanzi: '明天', pinyin: 'míng tiān', gloss: 'tomorrow', emoji: '➡️' },
    { id: 'zh-ti04', scenario: 'time', type: 'word', hanzi: '昨天', pinyin: 'zuó tiān', gloss: 'yesterday', emoji: '⬅️' },
    { id: 'zh-ti05', scenario: 'time', type: 'word', hanzi: '现在', pinyin: 'xiàn zài', gloss: 'now', emoji: '⏱️' },
    { id: 'zh-ti06', scenario: 'time', type: 'chunk', hanzi: '等一下', pinyin: 'děng yí xià', gloss: 'wait a moment', emoji: '✋' },
    { id: 'zh-ti07', scenario: 'time', type: 'sentence', hanzi: '今天星期几', pinyin: 'jīn tiān xīng qī jǐ', gloss: 'what day is it today?', emoji: '📆' },
    { id: 'zh-ti08', scenario: 'time', type: 'word', hanzi: '早上', pinyin: 'zǎo shang', gloss: 'morning', emoji: '🌅' },
    { id: 'zh-ti09', scenario: 'time', type: 'word', hanzi: '晚上', pinyin: 'wǎn shang', gloss: 'evening / night', emoji: '🌙' },
    { id: 'zh-ti10', scenario: 'time', type: 'sentence', hanzi: '几点开门', pinyin: 'jǐ diǎn kāi mén', gloss: 'what time do you open?', emoji: '🚪' },
    { id: 'zh-ti11', scenario: 'time', type: 'chunk', hanzi: '没有时间', pinyin: 'méi yǒu shí jiān', gloss: 'no time / out of time', emoji: '🏃' },
    { id: 'zh-ti12', scenario: 'time', type: 'chunk', hanzi: '快一点', pinyin: 'kuài yì diǎn', gloss: 'hurry up / a bit faster', emoji: '⚡' },

    // ---- People & Family ----
    { id: 'zh-p01', scenario: 'people', type: 'word', hanzi: '爸爸', pinyin: 'bà ba', gloss: 'dad', emoji: '👨' },
    { id: 'zh-p02', scenario: 'people', type: 'word', hanzi: '妈妈', pinyin: 'mā ma', gloss: 'mom', emoji: '👩' },
    { id: 'zh-p03', scenario: 'people', type: 'word', hanzi: '朋友', pinyin: 'péng you', gloss: 'friend', emoji: '🤝' },
    { id: 'zh-p04', scenario: 'people', type: 'word', hanzi: '孩子', pinyin: 'hái zi', gloss: 'child / kids', emoji: '👶' },
    { id: 'zh-p05', scenario: 'people', type: 'word', hanzi: '哥哥', pinyin: 'gē ge', gloss: 'older brother', emoji: '👦' },
    { id: 'zh-p06', scenario: 'people', type: 'word', hanzi: '妹妹', pinyin: 'mèi mei', gloss: 'younger sister', emoji: '👧' },
    { id: 'zh-p07', scenario: 'people', type: 'word', hanzi: '老师', pinyin: 'lǎo shī', gloss: 'teacher', emoji: '🏫' },
    { id: 'zh-p08', scenario: 'people', type: 'sentence', hanzi: '这是我朋友', pinyin: 'zhè shì wǒ péng you', gloss: 'this is my friend', emoji: '🤝' },
    { id: 'zh-p09', scenario: 'people', type: 'sentence', hanzi: '你有孩子吗', pinyin: 'nǐ yǒu hái zi ma', gloss: 'do you have children?', emoji: '❓' },
    { id: 'zh-p10', scenario: 'people', type: 'sentence', hanzi: '我有两个孩子', pinyin: 'wǒ yǒu liǎng ge hái zi', gloss: 'I have two kids', emoji: '✌️' },
    { id: 'zh-p11', scenario: 'people', type: 'chunk', hanzi: '他是谁', pinyin: 'tā shì shéi', gloss: 'who is he?', emoji: '🕵️' },
    { id: 'zh-p12', scenario: 'people', type: 'sentence', hanzi: '我们是朋友', pinyin: 'wǒ men shì péng you', gloss: 'we are friends', emoji: '👥' },

    // ---- Feelings & Reactions ----
    { id: 'zh-fe01', scenario: 'feelings', type: 'chunk', hanzi: '我喜欢', pinyin: 'wǒ xǐ huan', gloss: 'I like (it)', emoji: '❤️' },
    { id: 'zh-fe02', scenario: 'feelings', type: 'chunk', hanzi: '我不喜欢', pinyin: 'wǒ bù xǐ huan', gloss: "I don't like (it)", emoji: '💔' },
    { id: 'zh-fe03', scenario: 'feelings', type: 'chunk', hanzi: '我累了', pinyin: 'wǒ lèi le', gloss: "I'm tired", emoji: '😪' },
    { id: 'zh-fe04', scenario: 'feelings', type: 'word', hanzi: '开心', pinyin: 'kāi xīn', gloss: 'happy', emoji: '😄' },
    { id: 'zh-fe05', scenario: 'feelings', type: 'word', hanzi: '为什么', pinyin: 'wèi shén me', gloss: 'why?', emoji: '❓' },
    { id: 'zh-fe06', scenario: 'feelings', type: 'word', hanzi: '因为', pinyin: 'yīn wèi', gloss: 'because', emoji: '💡' },
    { id: 'zh-fe07', scenario: 'feelings', type: 'chunk', hanzi: '真的吗', pinyin: 'zhēn de ma', gloss: 'really?!', emoji: '😲' },
    { id: 'zh-fe08', scenario: 'feelings', type: 'word', hanzi: '当然', pinyin: 'dāng rán', gloss: 'of course', emoji: '😎' },
    { id: 'zh-fe09', scenario: 'feelings', type: 'chunk', hanzi: '太好了', pinyin: 'tài hǎo le', gloss: 'great! awesome!', emoji: '🎉' },
    { id: 'zh-fe10', scenario: 'feelings', type: 'chunk', hanzi: '没意思', pinyin: 'méi yì si', gloss: 'boring', emoji: '🥱' },
    { id: 'zh-fe11', scenario: 'feelings', type: 'chunk', hanzi: '有意思', pinyin: 'yǒu yì si', gloss: 'interesting / fun', emoji: '✨' },
    { id: 'zh-fe12', scenario: 'feelings', type: 'chunk', hanzi: '我爱你', pinyin: 'wǒ ài nǐ', gloss: 'I love you', emoji: '❤️' },

    // ---- Hotel & Wi-Fi ----
    { id: 'zh-h01', scenario: 'hotel', type: 'word', hanzi: '酒店', pinyin: 'jiǔ diàn', gloss: 'hotel', emoji: '🏨' },
    { id: 'zh-h02', scenario: 'hotel', type: 'word', hanzi: '房间', pinyin: 'fáng jiān', gloss: 'room', emoji: '🛏️' },
    { id: 'zh-h03', scenario: 'hotel', type: 'word', hanzi: '钥匙', pinyin: 'yào shi', gloss: 'key', emoji: '🔑' },
    { id: 'zh-h04', scenario: 'hotel', type: 'sentence', hanzi: '我有预订', pinyin: 'wǒ yǒu yù dìng', gloss: 'I have a reservation', emoji: '📝' },
    { id: 'zh-h05', scenario: 'hotel', type: 'sentence', hanzi: 'Wi-Fi 密码是什么', pinyin: 'Wi-Fi mì mǎ shì shén me', gloss: "what's the Wi-Fi password?", emoji: '📶' },
    { id: 'zh-h06', scenario: 'hotel', type: 'chunk', hanzi: '几楼', pinyin: 'jǐ lóu', gloss: 'which floor?', emoji: '🏢' },
    { id: 'zh-h07', scenario: 'hotel', type: 'word', hanzi: '空调', pinyin: 'kōng tiáo', gloss: 'air conditioning', emoji: '❄️' },
    { id: 'zh-h08', scenario: 'hotel', type: 'word', hanzi: '热水', pinyin: 'rè shuǐ', gloss: 'hot water', emoji: '♨️' },
    { id: 'zh-h09', scenario: 'hotel', type: 'chunk', hanzi: '太吵了', pinyin: 'tài chǎo le', gloss: 'too noisy', emoji: '🔊' },
    { id: 'zh-h10', scenario: 'hotel', type: 'sentence', hanzi: '可以换房间吗', pinyin: 'kě yǐ huàn fáng jiān ma', gloss: 'can I change rooms?', emoji: '🔄' },
    { id: 'zh-h11', scenario: 'hotel', type: 'word', hanzi: '退房', pinyin: 'tuì fáng', gloss: 'check out', emoji: '🧳' },
    { id: 'zh-h12', scenario: 'hotel', type: 'sentence', hanzi: '帮我叫出租车', pinyin: 'bāng wǒ jiào chū zū chē', gloss: 'call a taxi for me, please', emoji: '🚕' },

    // ---- Opinions & Chat ----
    { id: 'zh-c01', scenario: 'chat', type: 'chunk', hanzi: '我觉得', pinyin: 'wǒ jué de', gloss: 'I think…', emoji: '🤔' },
    { id: 'zh-c02', scenario: 'chat', type: 'word', hanzi: '可能', pinyin: 'kě néng', gloss: 'maybe', emoji: '🤷' },
    { id: 'zh-c03', scenario: 'chat', type: 'word', hanzi: '一起', pinyin: 'yì qǐ', gloss: 'together', emoji: '👥' },
    { id: 'zh-c04', scenario: 'chat', type: 'chunk', hanzi: '明天见', pinyin: 'míng tiān jiàn', gloss: 'see you tomorrow', emoji: '👋' },
    { id: 'zh-c05', scenario: 'chat', type: 'sentence', hanzi: '你做什么工作', pinyin: 'nǐ zuò shén me gōng zuò', gloss: 'what do you do for work?', emoji: '💼' },
    { id: 'zh-c06', scenario: 'chat', type: 'sentence', hanzi: '我是学生', pinyin: 'wǒ shì xué sheng', gloss: "I'm a student", emoji: '🎓' },
    { id: 'zh-c07', scenario: 'chat', type: 'chunk', hanzi: '太忙了', pinyin: 'tài máng le', gloss: 'so busy!', emoji: '🏃' },
    { id: 'zh-c08', scenario: 'chat', type: 'word', hanzi: '周末', pinyin: 'zhōu mò', gloss: 'weekend', emoji: '🎉' },
    { id: 'zh-c09', scenario: 'chat', type: 'sentence', hanzi: '我们一起去吧', pinyin: 'wǒ men yì qǐ qù ba', gloss: "let's go together", emoji: '🚶' },
    { id: 'zh-c10', scenario: 'chat', type: 'chunk', hanzi: '好主意', pinyin: 'hǎo zhǔ yi', gloss: 'good idea!', emoji: '💡' },
    { id: 'zh-c11', scenario: 'chat', type: 'chunk', hanzi: '改天吧', pinyin: 'gǎi tiān ba', gloss: 'another day / rain check', emoji: '📆' },
    { id: 'zh-c12', scenario: 'chat', type: 'chunk', hanzi: '加油', pinyin: 'jiā yóu', gloss: 'keep going! you got this!', emoji: '💪' },
  ],
};
