// XpressLingua service worker.
// Strategy: cache-first for immutable assets (audio, images, fonts, hashed JS),
// network-first for navigations so deploys show up on next visit.
const CACHE = 'xl-v1';
